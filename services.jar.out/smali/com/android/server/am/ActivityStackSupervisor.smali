...
.field private mailPackageName:Ljava/lang/String;
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;Landroid/os/IBinder;Ljava/lang/String;IIILjava/lang/String;IIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;Lcom/android/server/am/TaskRecord;)I
    ...
    iget-object v5, v0, Lcom/android/server/am/ActivityStackSupervisor;->browserPackageName:Ljava/lang/String;
    ...
    .line 1353
    .local v24, "browserIntent":Landroid/content/Intent;
    invoke-static {}, Landroid/app/AppGlobals;->getPackageManager()Landroid/content/pm/IPackageManager;
    ...
    invoke-interface {v5, v0, v8, v9, v1}, Landroid/content/pm/IPackageManager;->resolveIntent(Landroid/content/Intent;Ljava/lang/String;II)Landroid/content/pm/ResolveInfo;

    move-result-object v25

    .line 1354
    .local v25, "browserResolveInfo":Landroid/content/pm/ResolveInfo;
    if-eqz v25, :cond_1
    ...
    iput-object v5, v0, Lcom/android/server/am/ActivityStackSupervisor;->browserPackageName:Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_4

    .line 1360
    .end local v24    # "browserIntent":Landroid/content/Intent;
    .end local v25    # "browserResolveInfo":Landroid/content/pm/ResolveInfo;
    :cond_1
    :goto_1
    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/android/server/am/ActivityStackSupervisor;->mailPackageName:Ljava/lang/String;
    ...
    .line 1363
    .local v32, "mailIntent":Landroid/content/Intent;
    invoke-static {}, Landroid/app/AppGlobals;->getPackageManager()Landroid/content/pm/IPackageManager;
    ...
    .line 1364
    .local v33, "mailResolveInfo":Landroid/content/pm/ResolveInfo;
    if-eqz v33, :cond_2
    ...
    iput-object v5, v0, Lcom/android/server/am/ActivityStackSupervisor;->mailPackageName:Ljava/lang/String;
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_3

    .line 1372
    .end local v32    # "mailIntent":Landroid/content/Intent;
    .end local v33    # "mailResolveInfo":Landroid/content/pm/ResolveInfo;
    :cond_2
    :goto_2
    if-nez v30, :cond_5
    ...
    iget-object v8, v0, Lcom/android/server/am/ActivityStackSupervisor;->mailPackageName:Ljava/lang/String;
    ...
    iget-object v8, v0, Lcom/android/server/am/ActivityStackSupervisor;->browserPackageName:Ljava/lang/String;
    ...
    .line 1442
    .local v39, "strData":Ljava/lang/String;
    :goto_6
    const/16 v5, 0x7556
    ...
    .end local v39    # "strData":Ljava/lang/String;
    :cond_10
    if-nez v30, :cond_11
    ...
    .end local v23    # "abort":Z
    .end local v27    # "componentPerm":I
    .end local v31    # "launchFlags":I
    .end local v36    # "sourceRecord":Lcom/android/server/am/ActivityRecord;
    .end local v37    # "stack":Lcom/android/server/am/ActivityStack;
    .end local v38    # "startAnyPerm":I
    :catch_3
    move-exception v5
